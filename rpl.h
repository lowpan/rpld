...
/* Isaque: This definitions follow RFC6550, can be found in: https://datatracker.ietf.org/doc/html/rfc6550#section-6 */
...
struct nd_rpl_padn
{
    uint8_t option_type;   // 0x01 for PadN
    uint8_t option_length; // N-2 (Ex: 5 -> 7 bytes de padding)
    uint8_t *padding;    // 7 bytes de padding zero
} PACKED;
